...
<script type='text/javascript'
    src='https://platform-api.sharethis.com/js/sharethis.js#property=6502b86395430c0012210bbe&product=sop'
    async='async'></script>
@endsection
            ...
            <div class="col-lg-8 bg-white">
                ...
                <div class="position-relative mb-3">
                    ...
                    <p class="bg-white text-center">
                        <small class="text-muted">{{ $blog->caption }}</small>
                    </p>
            ...
            <div class="col-lg-4 pt-3 pt-lg-0">
                ...
                <div class="pb-3">
                    ...
                    <div class="d-flex mb-3">
                        <img src="{{ asset('storage/'. $serupa->image) }}"
